...
code_dir = os.path.abspath(os.path.join(os.path.dirname(__file__),'..', 'CODE_maze_pause'))
...
def visualize_trained_agents(model_path='../CODE/EXPORT/q_models.npz', 
    ...
    if TRAPS_DO_STOP_FOR_A_TURN:
        ...
        rm_states_map = {'start': 0, 'v_lose': 2, 'v_escaped': 3, 'opened':4} 
...
if __name__ == "__main__":
    ...
    FILE_NAME = 'q_models_maze_easy_ep11000'    
